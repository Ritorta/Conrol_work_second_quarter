...
{
    public dog(int id, String animal_type, String name, String color, Date date_birth, List<String> commands)
    {
    ...
    public String toString() {
        return "Dog Id: " + id + " Animal type: " + animal_type + " Name: " + name + " Color: " + color + 
