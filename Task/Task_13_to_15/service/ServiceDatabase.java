...
public class ServiceDatabase {
	...
	*/
	...
	//  Багованная версия метода saveDatabase, скорее требует написание под себя новго метода loadDatabase,
	/* Внесены следующие изменения:
	- Сохраняет в красивую таблицу.
	 * 
	*/
	...
	Внесены следующие изменения:
	 - Чтение с пробелами, вроде работает.
	*/
	private void loadDatabase() {
		try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
			reader.readLine();
	...
	// 			saveDatabase(); // Повторное добавление плодит пробелы и приводит к ошибке, если испольховать разделение по пробелам
